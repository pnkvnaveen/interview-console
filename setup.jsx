...
/* eslint-disable */
function SetupScreen({ candidate, onChange, onStart }) {
  ...
  return (
    <div className="page-scroll fade-in">
      <div className="page-wrap">
        ...
        <h1 className="page-title">Who are you interviewing today?</h1>
        <p className="page-lede">
          A few details about the candidate. You'll get a clean copyable summary at the end.
        </p>
        ...
        <div className="field">
          <label className="field-label" htmlFor="f-gen">General comments</label>
          <textarea id="f-gen" className="textarea" style={{ minHeight: 72 }}
            value={candidate.generalComments || ''}
            placeholder="Any initial observations, recruiter notes, or context about this candidate"
